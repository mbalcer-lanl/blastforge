...
The .hdf5 file for the PLI NN emulator is too large to upload to github. So, obtain the "study012_modelState_epoch0100.hdf5" file from either Matt Balcer (mbalcer@lanl.gov) or Smyther Hsiao (smyther@lanl.gov). Once obtained, place this file in blastforge-main/examples/pli_3layer/data/emulator/. TODO: convert this emulator to ONNX format (or another format), to see if it is small enough to upload.
